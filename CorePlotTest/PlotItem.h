...
@property (nonatomic, readwrite, strong) NSString *xAxisTitle;
@property (nonatomic, readwrite, strong) NSString *yAxisTitle;
@property (nonatomic, readwrite, strong) NSString *dataTitle;
